...
public class MapGenerator : MonoBehaviour {
	...
	void GenerateMap() {
		...
		Debug.Log ("Generating map took " + (Time.realtimeSinceStartup - startTime));

		DrawMap ();

		GetComponent<MeshGenerator> ().GenerateMesh (map, mapScale);
	}
	...
	void ClearDrawnMap() {
		...
		Debug.Log ("Clearing map took " + (Time.realtimeSinceStartup - startTime));
	}
